...
g <- ggplot() +
 ...
 scale_fill_manual(values = colCAH, breaks = c(1:6), label = CAHlabel$CAHlabs) +
  theme_void() +
  labs(title = "Six classes de villes selon le profil social de leur population",
       subtitle = "Ensemble des aires urbaines en 2018, avec la caractérisation sociale des retraités",
       fill = "Aires urbaines...",
       caption = "PAVIM 2023\nSources : INSEE RP 2018\nExploitations principale et complémentaire.\n Profil de la population des 15 ans et plus selon les CSP en 26 postes (ACP + CAH).")
